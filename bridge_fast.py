...
TOOLS = {
    "files":"List files","shell":"Run commands","sms":"SMS",
    "contacts":"Contacts","calendar":"Calendar","battery":"Battery",
    "wifi":"WiFi","storage":"Storage","web":"Web","memory":"Memory",
    "skills":"Skills","mcp":"MCP","notify":"Notify","tts":"TTS",
    "install":"Install packages","camera":"Take photo",
    "screenshot":"Capture screen","tap":"Tap coordinates",
    "swipe":"Swipe gesture","type":"Type text","accessibility":"Control phone"
}
...
class H(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        try:
            ...
            # Instant responses - no subprocess
            ...
            elif "tap" in msg or "swipe" in msg or "type" in msg:
                result = "Accessibility actions available"
            else:
